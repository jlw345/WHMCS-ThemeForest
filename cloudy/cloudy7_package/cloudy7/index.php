      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-7 col-lg-8">
            <div class="wrapper">
              <div class="heading"><?php if(isset($cloudy7_redux_demo['page_blog_title'])){?>
                                    <?php echo wp_specialchars_decode(esc_html($cloudy7_redux_demo['page_blog_title']),ENT_QUOTES);?>
                                    <?php }else{?>
                                    <?php echo esc_html__( 'Blog', 'cloudy7' );
                                    }
                                    ?></div>
            </div>
          </div>
