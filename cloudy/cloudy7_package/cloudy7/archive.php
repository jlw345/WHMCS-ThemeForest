          ...
          <div class="col-sm-12 col-md-7 col-lg-8">
            <div class="wrapper">
              <div class="heading"><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'cloudy7' ), get_the_date() );
                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'cloudy7' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'cloudy7' ) ) );
                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'cloudy7' ), get_the_date( _x( 'Y', 'yearly archives date format', 'cloudy7' ) ) );
                        else :
                            echo esc_html__( 'Archives', 'cloudy7' );
                        endif;?>
