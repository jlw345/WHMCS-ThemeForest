              ...
              <div class="col-6 col-sm-7">
                <div class="float-right">
                  <div class="dropdown">
                    ...
                    <img src="<?php echo esc_url($cloudy7_redux_demo['flag1']['url']); ?>" width="16"> <?php echo wp_specialchars_decode(esc_attr($cloudy7_redux_demo['language1']));?><span class="caret"></span>
                    </a>
                  ...
                  <a href="<?php echo (esc_url($cloudy7_redux_demo['button_link']));?>"> <div class="btn btn-default-green question"><?php echo wp_specialchars_decode(esc_attr($cloudy7_redux_demo['text_button']));?></div></a>
                </div>
              </div>
            </div>
          </div>
