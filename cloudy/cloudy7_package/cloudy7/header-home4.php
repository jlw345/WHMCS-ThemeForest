...
<?php $cloudy7_redux_demo = get_option('redux_demo'); ?>
    ...
    <div class="menu-wrap navigation-menu classic top">
            ...
            <div class="row">
              <div class="col-9 col-sm-10">
                <div class="float-left pt-2">
                  <a href="<?php echo (esc_url($cloudy7_redux_demo['button_link']));?>"> <div class="btn btn btn-default-green question"><?php echo wp_specialchars_decode(esc_attr($cloudy7_redux_demo['text_button']));?></div></a>
                <div class="dropdown">
                  <a class="dropdown-toggle" id="dropdownMenuCoin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php echo esc_html__( 'USD ($)&nbsp; ', 'cloudy7' );?><span class="caret"></span>
                  </a>
              ...
              <div class="col-3 col-sm-2 float-right">
                <a class="float-right" href="<?php echo esc_url(home_url('/')); ?>">
                  <?php if(isset($cloudy7_redux_demo['logo2']['url']) && $cloudy7_redux_demo['logo2']['url'] != ''){ ?>
                      <img src="<?php echo esc_url($cloudy7_redux_demo['logo2']['url']); ?>" alt="logo" class="logo-menu p-0">
                  <?php }else{ ?>
