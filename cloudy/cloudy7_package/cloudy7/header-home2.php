...
<?php $cloudy7_redux_demo = get_option('redux_demo'); ?>
    ...
    <body <?php body_class(); ?>>
        ...
        <!-- header start -->
    <div class="menu-wrap navigation-menu dark">
            ...
            <div class="row">
              <div class="col-6 col-sm-8">
                <div class="dropdown">
                  ...
                  <img src="<?php echo esc_url($cloudy7_redux_demo['flag1']['url']); ?>" width="16" alt="en"> <?php echo wp_specialchars_decode(esc_attr($cloudy7_redux_demo['language1']));?><span class="caret"></span>
                  </a>
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuLang">
                      <a class="dropdown-item" href=""><img src="<?php echo esc_url($cloudy7_redux_demo['flag2']['url']); ?>" width="16"> <?php echo wp_specialchars_decode(esc_attr($cloudy7_redux_demo['language2']));?></a>
                      <a class="dropdown-item" href=""><img src="<?php echo esc_url($cloudy7_redux_demo['flag3']['url']); ?>" width="16"> <?php echo wp_specialchars_decode(esc_attr($cloudy7_redux_demo['language3']));?></a>
                  </div>
                </div>
                <div class="dropdown">
                ...
                <span><?php echo wp_specialchars_decode(esc_attr($cloudy7_redux_demo['email_text']));?></span> <a class="email" href="<?php echo (esc_url($cloudy7_redux_demo['email_link']));?>"><?php echo wp_specialchars_decode(esc_attr($cloudy7_redux_demo['email_address']));?></a>
              </div>
        ...
        <div class="row">
          <div class="col-3 col-md-3">
            <a href="<?php echo esc_url(home_url('/')); ?>">
              <?php if(isset($cloudy7_redux_demo['logo-menu-home3']['url']) && $cloudy7_redux_demo['logo-menu-home3']['url'] != ''){ ?>
                      <img src="<?php echo esc_url($cloudy7_redux_demo['logo-menu-home3']['url']); ?>" alt="logo" class="logo-menu-home3 p-0">
                  <?php }else{ ?>
                      <img src="<?php echo get_template_directory_uri();?>/img/logo-light.svg" alt="logo" class="logo-menu p-0">
                  <?php } ?></a>
          </div>
