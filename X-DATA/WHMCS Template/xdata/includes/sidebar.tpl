{foreach $sidebar as $item}
    <div menuItemName="{$item->getName()}" class="panel {if $item->getClass()}{$item->getClass()}{else} panel-custom {/if}{if $item->getExtra('mobileSelect') and $item->hasChildren()} hidden-sm hidden-xs{/if}"{if $item->getAttribute('id')} id="{$item->getAttribute('id')}"{/if}>
        <div class="panel-heading custom-bot">
