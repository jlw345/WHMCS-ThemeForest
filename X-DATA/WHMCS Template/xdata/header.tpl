        ...
        <div id="top-nav">
            ...
            {if $languagechangeenabled && count($locales) > 1}
                <div class="pull-right nav">
                    <a class="quick-nav" data-toggle="popover" id="languageChooser"><i class="fa fa-language customicon"></i></a>
            ...
            {if $loggedin}
                <div class="pull-right nav">
                    <a class="quick-nav" data-toggle="popover" id="accountNotifications" data-placement="bottom" title="{lang key="notifications"}"><i class="fa fa-info customicon"></i><span class="count-cart">{$clientAlerts|count}</span></a>
                    <div id="accountNotificationsContent" class="hidden">
                        ...
                        {foreachelse}
                            <div class="clientalert text-success"><i class="fa fa-check-square-o customicon"></i> {$LANG.notificationsnone}</div>
                        {/foreach}
                    </div>
                </div>
            {else}
                <div class="pull-right nav">
                    <a href="#" class="quick-nav" data-toggle="popover" id="loginOrRegister" data-placement="bottom"><i class="fa fa-user customicon"></i> {$LANG.login}</a>
            ...
            <!-- Shopping Cart -->
            <div class="pull-right nav">
                <a href="{$WEB_ROOT}/cart.php?a=view" class="quick-nav"><i class="fa fa-shopping-cart customicon"></i><span class="count-cart" id="cartItemCount">{$cartitemcount}</span></a>
            </div>
...
{if $templatefile == 'homepage'}
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                            <div class="input-group input-group-lg">
                                <input type="text" class="dom-input-c" name="domain" placeholder="{$LANG.exampledomain}" autocapitalize="none" />
                                <span class="input-group-btn">
                                    {if $registerdomainenabled}
                                        <input type="submit" class="search-btn-c" value="{$LANG.search}" />
                                    {/if}
                                    {if $transferdomainenabled}
                                        <input type="submit" name="transfer" class="transfer-btn-c" value="{$LANG.domainstransfer}" />
                                    {/if}
                                </span>
                            </div>
                        </div>
    ...
    <div class="home-shortcuts">
        <div class="container">
            <div class="row">
                <div class="col-md-push-2 col-sm-12 col-md-8">
                    <ul>
                        {if $registerdomainenabled || $transferdomainenabled}
                            <li>
