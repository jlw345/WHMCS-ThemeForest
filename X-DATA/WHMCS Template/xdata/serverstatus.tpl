<div class="row">
    <div class="col-lg-4">
        <div class="well red">
            <span class="label label-danger pull-right flip">{$opencount}</span><a href="{$smarty.server.PHP_SELF}?view=open" class="networkissuesopen">{$LANG.networkissuesstatusopen}</a>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="well yellow">
            <span class="label label-warning pull-right flip">{$scheduledcount}</span><a href="{$smarty.server.PHP_SELF}?view=scheduled" class="networkissuesscheduled">{$LANG.networkissuesstatusscheduled}</a>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="well green">
            <span class="label label-success pull-right flip">{$resolvedcount}</span><a href="{$smarty.server.PHP_SELF}?view=resolved" class="networkissuesclosed">{$LANG.networkissuesstatusresolved}</a>
        </div>
    </div>
</div>
