...
document.write('\
<div class="crypto--calculator-inner text-center">\
    <div>\
		<ul class ="list-unstyled">\
			<li>\
				<input id="amount-1" type="text" placeholder="0">\
			</li>\
			<li class="crypto-slect">\
		...
		<ul class ="list-unstyled">\
			<li>\
				<input id="amount-2" type="text" placeholder="0">\
			</li>\
			<li>\
    ...
    <div class="powared-by" style="text-align:center;font-size:10px;opacity:0.6;padding-top:10px;">Powered by <a href="https://www.cryptonator.com" style="color:' + crypt_calc_font_color + ';" target="_blank">Cryptonator Bitcoin wallet</a></div>\
</div>');
