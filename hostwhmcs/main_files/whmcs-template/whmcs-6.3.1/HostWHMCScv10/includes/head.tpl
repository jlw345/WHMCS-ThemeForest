...
<link href="{$WEB_ROOT}/templates/{$template}/css/hostwhmcs-style.css" rel="stylesheet">
<link href="{$WEB_ROOT}/templates/{$template}/css/colors/theme-color-10.css" rel="stylesheet">
