...
<link href="{$WEB_ROOT}/templates/{$template}/css/styles-modified-rtl.css" rel="stylesheet">
<link href="{$WEB_ROOT}/templates/{$template}/css/styles-rtl.css" rel="stylesheet">
