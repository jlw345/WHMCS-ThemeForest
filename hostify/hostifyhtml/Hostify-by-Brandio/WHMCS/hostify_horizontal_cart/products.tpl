            ...
            <div id="products" class="price-table-container">
                <ul id="sub-pricing">
                    {foreach $products as $product}
                		...
                		{/if}
                        <li id="product{$product@iteration}" class="col-md-12 pricing-box-horizontal-holder">
                            <div class="pricing-box pricing-box-simple pricing-box-horizontal pricing-color{$counter}{if $product.isFeatured} bestbuy{/if}" style="width: 100%">
                                <div class="pricing-content">
                                    ...
                                    $('#product{$product@iteration} .pricing-details .pricing-features').detach().appendTo('#product{$product@iteration} .pricing-features-holder');
                                    if ($('#product{$product@iteration} .pricing-features-holder').children().length <= 0 ) {
                                        $('#product{$product@iteration} .pricing-features-holder').remove();
                                    }
                                    </script>
