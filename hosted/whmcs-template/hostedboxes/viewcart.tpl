    ...
    {else}
        ...
        <form method="post" action="{$smarty.server.PHP_SELF}?a=checkout" name="orderfrm" id="frmCheckout">
                ...
                <div class="row">
                    {foreach $customfields as $customfield}
                        <div class="form-horizontal">
                            <label class="control-label" for="customfield{$customfield.id}">
                                {$customfield.name}
                            </label>
                            <div class="">
                                {$customfield.input}
            ...
            {if !$loggedin}
                ...
                <div class="form-horizontal">
                    ...
                    {if $securityquestions}
                        ...
                        <div class="form-group">
                            <label for="inputSecurityQAns" class="control-label">{$LANG.clientareasecurityanswer}</label>
                            <div class="">
            ...
            {if $domainsinorder}
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <label for="inputDomainContact" class="control-label">{$LANG.domainregistrantchoose}</label>
                        <div class="">
