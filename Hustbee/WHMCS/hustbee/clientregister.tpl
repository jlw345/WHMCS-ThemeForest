                ...
                <div class="login-register-form">
                    <div class="form-holder">
                        ...
                        <div class="form-row form-links">
                            <div class="col-xs-12">
                                <a href="{$WEB_ROOT}/clientarea.php" class="link-to">{$LANG.login}</a> or <a href="{$WEB_ROOT}/register.php" class="link-to active">{$LANG.register}</a>
                            </div>
                        </div>
                        <div id="registration">
                            <form method="post" class="using-password-strength" action="{$smarty.server.PHP_SELF}" role="form" name="orderfrm" id="frmCheckout">
                                ...
                                <div class="submit-holder">
                                    <input type="submit" value="{$LANG.clientregistertitle}"/>
                                </div>
                            </form>
                        </div>
                    </div>
