...
<link rel="stylesheet" id="slider-2-css" type="text/css" href="{$WEB_ROOT}/templates/orderforms/slider_cart_2/css/slider2.css" media="all" />
...
<div id="order-standard_cart">
    ...
    <div class="row">
        ...
        <div class="col-md-9 pull-md-left">
            ...
            <div id="slider_container_outer2" class="slider-container slider_container_outer2 bg_color_fafafa">
