    ...
    <div class="row">
        ...
        <div class="col-md-9 pull-md-left">
            ...
            <div class="domain-pricing">
                ...
                <div class="domain-pricing-custom">
                <div class="tld-pricing-header text-center">

                        <div class="domain-pricing-custom-th">
                    <div class="col-sm-4 no-bg">{lang key='orderdomain'}</div>
                    <div class="col-sm-8 th-col8">
                        <div class="row">
                ...
                {foreach $pricing['pricing'] as $tld => $price}
                    <div class="row tld-row " data-category="{foreach $price.categories as $category}|{$category}|{/foreach}">
                        <div class="col-sm-4 two-row-center tld_custom_box">
                            <strong>.{$tld}</strong>
                            {if $price.group}
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col-xs-4 text-center tld_custom_box">
