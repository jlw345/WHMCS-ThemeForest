...
<link rel="stylesheet" id="slider-3-css" type="text/css" href="{$WEB_ROOT}/templates/orderforms/slider_cart_3/css/slider3.css" media="all" />
...
<div id="order-standard_cart">
    ...
    <div class="row">
        ...
        <div class="col-md-9 pull-md-left">
            ...
            <div id="slider_container_outer3" class="slider-container slider_container_outer3 bg_color_fafafa">
