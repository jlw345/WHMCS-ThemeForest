...
<!-- 3Host Styling -->
<link href="{$WEB_ROOT}/templates/{$template}/css/style-theme.css" rel="stylesheet">
<link href="{$WEB_ROOT}/templates/{$template}/css/magenta-dark-skin.css" rel="stylesheet"> 
